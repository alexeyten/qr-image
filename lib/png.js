...
var PNG_IHDR  = Buffer.from([0,0,0,13,73,72,68,82,0,0,0,0,0,0,0,0,8,3,0,0,0,0,0,0,0]);  // PNG_IHDR[17] = 3, meaning Index color
...
var PNG_PLTE  = Buffer.from([0,0,0,6,0x50,0x4c,0x54,0x45,0,0,0,255,255,255,0,0,0,0]);

// Transparency chunk for indexed color image.
// PNG_tRNS[8]=transparency of color #0
// PNG_tRNS[9]=transparency of color #1
var PNG_tRNS  = Buffer.from([0,0,0,2,0x74,0x52,0x4e,0x53,0xff,0x00,0,0,0,0]);
